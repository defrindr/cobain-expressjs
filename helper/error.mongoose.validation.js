module.exports = function (mongoose) {
    ...
    msg.String.minlength = 'Panjang kolom `{PATH}` (`{VALUE}`) kurang dari ({MINLENGTH}) karakter.';
    msg.String.maxlength = 'Panjang kolom `{PATH}` (`{VALUE}`) lebih dari ({MAXLENGTH}) karakter.';
}
